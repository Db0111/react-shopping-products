...
const Container$5 = newStyled.div`
  ...
  height: inherit;
`;
const FallbackImage = newStyled.img`
  width: 250px;
  height: 250px;
`;
const Message$1 = newStyled.p`
  ...
  font-weight: 600;
`;
const defaultImage = "/react-shopping-products/assets/planet-error-_tDXywh0.png";
function ErrorFallback({ message }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$5, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FallbackImage, { src: defaultImage, alt: `오류 행성이` }),
...
function APIProvider({ children }) {
  ...
  const [refetchFunctions, setRefetchFunctions] = reactExports.useState({});
  const setRefetchFunction = reactExports.useCallback(
    (name, refetchFn) => {
      setRefetchFunctions((prev2) => ({ ...prev2, [name]: refetchFn }));
    },
    []
  );
...
function LoadingFallback({ message }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$5, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FallbackImage, { src: planetLoadingImage, alt: `로딩 행성이` }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Message$1, { children: message })
  ] });
}
...
const Logo = newStyled.a`
  ...
  font-weight: 800;
`;
const CardItemButton = newStyled.button`
  display: flex;
  position: relative;
`;
const QuantityBox = newStyled.p`
  position: absolute;
  ...
  justify-content: center;
`;
const cartItemIcon = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='33'%20height='32'%20viewBox='0%200%2033%2032'%20fill='none'%3e%3cpath%20d='M16.292%203.99998C15.4822%203.99998%2014.7289%204.21152%2014.0321%204.6346C13.3353%205.03844%2012.7798%205.59613%2012.3654%206.30767C11.97%207.01921%2011.7722%207.78844%2011.7722%208.61537V9.53844H7.30894L7.25244%2010.4038L6.29199%2028H26.292L25.3315%2010.4038L25.275%209.53844H20.8118V8.61537C20.8118%207.78844%2020.6046%207.01921%2020.1903%206.30767C19.7948%205.59613%2019.2487%205.03844%2018.5519%204.6346C17.8551%204.21152%2017.1018%203.99998%2016.292%203.99998ZM16.292%205.84613C17.0453%205.84613%2017.6856%206.11537%2018.2129%206.65383C18.7402%207.19229%2019.0039%207.84613%2019.0039%208.61537V9.53844H13.5801V8.61537C13.5801%207.84613%2013.8438%207.19229%2014.3711%206.65383C14.8984%206.11537%2015.5387%205.84613%2016.292%205.84613ZM9.00386%2011.3846H11.7722V14.1538H13.5801V11.3846H19.0039V14.1538H20.8118V11.3846H23.5801L24.3711%2026.1538H8.2129L9.00386%2011.3846Z'%20fill='white'/%3e%3c/svg%3e";
function CartItemButton({ quantity, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardItemButton, { type: "button", onClick, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: cartItemIcon, alt: "장바구니" }),
    quantity >= 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(QuantityBox, { "data-testid": "cart-item-quantity", children: quantity })
  ] });
}
function Header({ quantity, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Header$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { href: "/", children: "SHOP" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartItemButton, { quantity, onClick })
  ] });
}
...
const Title$1 = ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx(StyledTitle, { children });
...
const Container$4 = newStyled.div`
  ...
  align-items: center;
  justify-content: center;
  background-color: ${({ type }) => type === "success" ? "#8FD292" : "#FF8C8C "};
  color: #0a0d13;
  z-index: 999;
`;
...
function AddCartItemButton({ id: id2, disabled }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    (error == null ? void 0 : error.message) && /* @__PURE__ */ jsxRuntimeExports.jsx(AlertToast, { type: "error", message: error.message }, error.message),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button$1,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: addCartItemIcon, alt: "장바구니 담기" }),
          "담기"
        ]
      }
    )
...
const ProductImage = newStyled.img`
  ...
  height: 100%;
  object-fit: cover;
  border-radius: ${({ variant }) => variant === "cart" ? "6px" : "8px 8px 0 0"};
`;
...
const ButtonWrapper$1 = newStyled.div`
  ...
  `};
`;
const ItemBackDrop = newStyled.div`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
const Icon = newStyled.img`
  width: 12px;
`;
const Quantity = newStyled.span`
  font-size: 14px;
  font-weight: 500;
`;
const plusIcon = "data:image/png;base64,";
const minusIcon = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAA8AAAACCAYAAACHSIaUAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAySURBVHgBlc0xFQAgDAPRwNatEpARGyjDasdsoRZ6+3+3SB7bD0BiUETcLammsGfVLj8hRg+hfhjqDAAAAABJRU5ErkJggg==";
...
function ProductItem({ product, variant }) {
  ...
  const findCartItem = cartItemData.find(({ product: product2 }) => product2.id === id2);
  const cartQuantity = findCartItem ? findCartItem.quantity : 1;
  const handleImageError = (e2) => {
    e2.currentTarget.src = defaultImage;
  };
  const handleIncrease = async () => {
    ...
    if (newQuantity > quantity) {
      setError((prev2) => ({
        ...prev2,
        cartItemData: error instanceof Error ? error.message : "재고 수량을 초과해서 담을 수 없습니다."
      }));
      return;
    }
    if (findCartItem) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Item, { variant, children: [
    error.cartItemData && /* @__PURE__ */ jsxRuntimeExports.jsx(AlertToast, { type: "error", message: error.cartItemData }),
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ImageWrapper, { variant, children: [
      quantity <= 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ItemBackDrop, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SoldOutText, { children: "품 절" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProductImage, { src: imageUrl, alt: name, onError: handleImageError })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Content$1, { variant, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonWrapper$1, { variant, children: !findCartItem ? /* @__PURE__ */ jsxRuntimeExports.jsx(AddCartItemButton, { id: id2, disabled: quantity <= 0 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        QuantityCounter,
        {
...
const ProductList$1 = newStyled.ul`
  width: 100%;
  display: grid;
  ...
  margin-bottom: 20px;
`;
const EmptyProductList = newStyled.div`
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
...
function ProductList({ productItemList }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: productItemList.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ProductList$1, { children: productItemList.map((productItem) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    productItem.id
  )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyProductList, { children: "등록된 상품이 없습니다." }) });
}
...
const Title = newStyled.h1`
  ...
  font-weight: 700;
`;
const FILTER_OPTIONS = ["전체", "식료품", "패션잡화"];
const SORT_OPTIONS = ["낮은 가격순", "높은 가격순"];
...
const DropdownWrapper = newStyled.div`
  width: 150px;
`;
const useClickOutsideRef = (callback) => {
  const ref = reactExports.useRef(null);
  reactExports.useEffect(
    function clickOutsideEffect() {
      const handleDocumentClick = (e2) => {
        const container = ref.current;
        if (!container || container.contains(e2.target)) {
          return;
        }
        callback();
      };
...
const Container$1 = newStyled.div`
  ...
  width: 100%;
`;
const DropdownTrigger = newStyled.button`
  width: 100%;
  padding: 8px;
  display: flex;
  justify-content: space-between;
...
`;
const OptionItemButton = newStyled.button`
  font-size: 14px;
  width: 100%;
  padding: 8px;
  text-align: left;
...
function Dropdown({
  ...
  const dropdownRef = useClickOutsideRef(
    () => setIsOpen(false)
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { ref: dropdownRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DropdownTrigger,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowIcon, { direction: isOpen ? "down" : "up" })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(OptionList, { children: optionList.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(OptionItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      OptionItemButton,
      {
        type: "button",
...
function FilterSortControl({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownWrapper, { "data-testid": "filter-dropdown", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dropdown,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownWrapper, { "data-testid": "sort-dropdown", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dropdown,
      {
...
const useData = ({ fetchFn, name }) => {
  ...
  const fetchData = reactExports.useCallback(async () => {
    ...
    try {
      ...
      setData((prev2) => ({ ...prev2, [name]: response }));
    } catch (error) {
...
function ProductContent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$2, { children: [
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, { message: "상품 목록을 가져오는 중 입니다..." }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      ErrorBoundary,
      {
...
const ItemWrapper = newStyled.div`
  display: flex;
  flex-direction: row;
  width: 100%;
  justify-content: space-between;
...
function ProductPage() {
  ...
  const price = cartItemData == null ? void 0 : cartItemData.reduce(
    (acc, cur) => acc + cur.product.price * cur.quantity,
    0
  );
  if (isLoading || !cartItemData)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, { message: "로딩 중입니다..." });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { quantity: cartItemData.length, onClick: handleClick }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProductContent, {}),
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { position: "bottom", isOpen, onClose: handleClick, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Title, { children: "장바구니" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ItemContent, { children: cartItemData.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(ItemWrapper, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ProductItem,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonWrapper, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RemoveCartItemButton, { id: item.id }) })
      ] }, item.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceWrapper, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Modal.Title, { children: "총 결제 금액" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal.Title, { children: [
          price,
          "원"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CloseButton, { onClick: handleClick, children: "닫기" })
    ] })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(APIProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ErrorBoundary,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductPage, {})
    }
  ) });
}
...
function MobileLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidePanel, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidePanelText, { children: "상품 목록 미션" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Content, { children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidePanel, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidePanelText, { children: "메이토 & 써밋" }) })
  ] });
}
...
enableMocking().then(() => {
  client.createRoot(document.getElementById("root")).render(
    /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MobileLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
  );
});
